...
const steedsByUser = async (parent, args, context, info) => {
  ...
  const steeds = await context.prisma
    .user({ id: args.user })
    .steeds({ orderBy: "id_DESC" });
  return steeds;
};
...
const plates = async (parent, args, context, info) => {
  ...
  const plates = await context.prisma.plats({
    orderBy: "id_DESC",
...
const orderedPlatesByUser = async (parent, args, context, info) => {
  ...
  const orderedPlates = await context.prisma.usersOnPlateses({
...
const orderedHousesByUser = async (parent, args, context, info) => {
  ...
  const orderedHousesByUser = await context.prisma.usersOnHouseses({
    where: { user: { id: args.user } },
  });
...
const orderedProductsByUser = async (parent, args, context, info) => {
  ...
  const orderedProductsByUser = await context.prisma.usersOnProductses({
    where: { user: { id: args.user } },
  });
...
const platesAll = async (parent, args, context, info) => {
  console.log("platesAll query");
  const plates = await context.prisma.plats({ orderBy: "id_DESC" });
  return plates;
};
const housesAll = async (parent, args, context, info) => {
  console.log("housesAll query");
  const houses = await context.prisma.houses({ orderBy: "id_DESC" });
  return houses;
};
const productsAll = async (parent, args, context, info) => {
  console.log("productsAll query");
...
const categories = async (parent, args, context, info) => {
  console.log("categories mutation");
  const categories = await context.prisma.categories({ orderBy: "id_DESC" });
  return categories;
};
module.exports = {
  info,
